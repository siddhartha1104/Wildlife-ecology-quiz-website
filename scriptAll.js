const questions = [
  ...
  {
    question:
      "What is the term for a trait that is controlled by multiple genes?",
    answers: [
  ...
  {
    question:
      "Which structure in the cell is responsible for regulating what enters and leaves the cell?",
    answers: [
  ...
  {
    question:
      "Which international agreement aimed at reducing greenhouse gas emissions was adopted in 1997?",
    answers: [
  ...
  // 10
  {
    ...
    answers: [
      ...
      {
        text: "A species that spreads aggressively in a new habitat",
        correct: true,
      },
      { text: "A species that is extinct", correct: false },
      {
        text: "A species that is highly adapted to its environment",
        correct: false,
      },
    ],
  },
  ...
  // 7
  {
    ...
    answers: [
      {
        text: "Meeting current needs without compromising future generations",
        correct: true,
      },
  ...
  {
    question:
      "What is the term for a species that is found only in one specific habitat?",
    answers: [
  ...
  {
    question:
      "Which of the following ecosystems is characterized by permafrost?",
    answers: [
  ...
  {
    question:
      "What is the term for the gradual transition of an ecosystem following a disturbance?",
    answers: [
  ...
  // 7
  {
    ...
    answers: [
      {
        text: "To promote awareness and understanding of environmental issues",
        correct: true,
      },
  ...
  // 9
  {
    ...
    answers: [
      ...
      {
        text: "To protect natural resources for future generations",
        correct: true,
      },
  ...
  {
    question:
      "What is the term for the warming of the Earth's surface due to human activity?",
    answers: [
      { text: "Global warming", correct: true },
      { text: "Ozone depletion", correct: false },
  ...
  {
    question:
      "What is the term for the process of converting waste into reusable material?",
    answers: [
      { text: "Recycling", correct: true },
  ...
  {
    question:
      "Which of the following is a consequence of plastic waste in the ocean?",
    answers: [
  ...
  // 8
  {
    ...
    answers: [
      {
        text: "the maximum sustainable yield is near the beginning of the sigmoidal curve",
        correct: false,
      },
      {
        text: "the maximum sustainable yield is near the mid-point of the sigmoidal curve",
        correct: true,
      },
      {
        text: "the maximum sustainable yield is near the end of the sigmoidal curve",
        correct: false,
      },
      { text: "none of these", correct: false },
    ],
  ...
  {
    question:
      "In the food chain: grass --> grasshopper --> frog --> snake --> hawk, the frog is a",
    answers: [
  ...
  {
    question:
      "Because of climate change, Mudumalai Tiger Reserve is suffering from frequent droughts. The management has built several artificial water holes for animals and fills them up regularly with tankers. This action is an example of",
    answers: [
...
const displayQuestions = () => {
  ...
  questions.forEach((question, index) => {
    ...
    questionDiv.innerHTML = `
            <label class="question-label">${index + 1}. ${
      question.question
    }</label>
            ${question.answers
              .map(
...
const handleSubmit = (event) => {
  ...
  userAnswers.forEach((answer, index) => {
    ...
    const correctAnswer = questions[index].answers.find(
      (ans) => ans.correct
    ).text;
